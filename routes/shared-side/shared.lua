...
Config = {
	["Coleta"] = {
		...
		["Init"] = vec3(3800.73,4439.93,4.44), -- Coordenada de inicio do emprego (use o comando /postit)
		["Experience"] = {
			["Name"] = "Lumberman", -- Nome da experiência
			["Amount"] = 1 -- Quantidade recebida
		},
		["List"] = {
			{ ["Item"] = "joint", ["Chance"] = 25, ["Min"] = 1, ["Max"] = 3, ["Price"] = 35 },
			{ ["Item"] = "weaponparts", ["Chance"] = 25, ["Min"] = 1, ["Max"] = 3, ["Price"] = 250 },
			{ ["Item"] = "cocaine", ["Chance"] = 25, ["Min"] = 1, ["Max"] = 3, ["Price"] = 35 },
			{ ["Item"] = "meth", ["Chance"] = 25, ["Min"] = 1, ["Max"] = 3, ["Price"] = 35 },
			{ ["Item"] = "scrapmetal", ["Chance"] = 25, ["Min"] = 1, ["Max"] = 3, ["Price"] = 2 },
			{ ["Item"] = "screwnuts", ["Chance"] = 25, ["Min"] = 1, ["Max"] = 3, ["Price"] = 75 },
			{ ["Item"] = "screws", ["Chance"] = 25, ["Min"] = 1, ["Max"] = 3, ["Price"] = 75 },
			{ ["Item"] = "blueprint_fragment", ["Chance"] = 25, ["Min"] = 1, ["Max"] = 3, ["Price"] = 2000 },
			{ ["Item"] = "lockpick", ["Chance"] = 25, ["Min"] = 1, ["Max"] = 3, ["Price"] = 200 }
		},
		["Coords"] = {
	...
	}, -- CASO QUEIRA FAZER OUTRO SÓ COPIAR O CODIGO E REFAZER DE ACORDO COM AS PERMISSÕES
}